<html>
  <head>
  <head>
  <title>Sub Exam Center</title>
  <meta name="keywords" content="Sub, Exam, Center">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 id='heading1'><i>Regarding Sub Exam Center</i></h1>
   	  	</div>
   	  </div>
    
      <div class="row" style="margin-top: 3%" padding="30px">
        <div class="col-md">
          <embed src="pdf/SubExam.pdf" type="application/pdf" width="100%" height="900px" ></embed>
        </div>
        </div>
  </div>
</body>
