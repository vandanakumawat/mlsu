<html>
  <head>
  <title>AQAR2017</title>
      <meta name="keywords" content="aqar, 2017, 16">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 class='heading'><i>AQAR 2017-18</i></h1>
   	  	</div>
   	  </div>
    
      <div class="row" style="margin-top: 3%" padding="30px">
        <div class="col-md">
          <embed src="pdf/AQAR3.pdf" type="application/pdf" width="100%" height="400px" ></embed>
        </div>
        </div>
  </div>
</body>
