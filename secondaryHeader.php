...
?>
    <link rel="stylesheet" type = "text/css" href="css/secondaryHeader.css">
    ...
    <table height="100%" width="100%">
        <tr>
            <td rowspan="2" style="text-align: left;" width="50%">
                <a href="home.php"><img style="padding-left: 10px;" src="images/logo.png" width="388.8px" height="66px"></a>
            </td>
        </tr>
