...
?>
    ...
    <div class="footer">
        <table cellpadding="10px" width="100%" >
            <tr>
                <td id="footerHead" colspan="2"> <b> Important Links </b> </td>
                <td id="footerHead"> &nbsp;&nbsp; <b> Address </b> </td>
                <td id="footerHead" colspan="2"> <b> Locate Us </b> </td>
            </tr>
            ...
            <tr>
                <td id="footerLinks" colspan="3" >
                    ...
                    <a href="#"> 
                        <img id="contactLinkedIn" onmouseover="document.getElementById('contactLinkedIn').src='images/contactLinkedInHover.png'" onmouseleave="document.getElementById('contactLinkedIn').src='images/contactLinkedIn.png'" src="images/contactLinkedIn.png" alt="L" height="30px" width="30px"></a>
                    &nbsp;&nbsp;&nbsp;
                    <a href="#"> 
