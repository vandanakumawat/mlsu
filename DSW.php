<html>
  <head>
    <title>D.S.W.</title>
    <meta name="keywords" content="dsw, dsw">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 class='heading'><i>D.S.W.</i></h1>
   	  	</div>
   	  </div>
      <div class="row">
       <div class="col-md">
         <img src="images/faculty/default.jpg" class="images"  height="40%" width="40%"  style="margin-left: 20px;margin-top: 5%"><br/>
          <h5 style="margin-left: 20px" class="subheading">Prof. B.L. Verma</h5>
          <p  style="margin-left: 20px" class="content">
            Dean Students Welfare</p> 
        </div>
        <div class="col-md">
