<html>
  <head>
    ...
    <meta name="keywords" content="old, question, paper, papers, old, question, paper, papers">
     <meta charset="utf-8">
...
<script src="javascript/fetchOldPapers.js"></script>
<script>
    ...
    <div class="row">
        <div class='col-md'>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <select class="form-control" id="courseCombo" onchange="fetchPapers(this.value)" name="syllabusCourse">
