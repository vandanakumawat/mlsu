<html>
  ...
  <meta name="keywords" content="Skill, Development, Programme, Infosys, undergraduates, FMS">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 id='heading1'><i>Skill Development Programme by Infosys for undergraduates @ FMS</i></h1>
   	  	</div>
   	  </div>
    
      <div class="row" style="margin-top: 3%" padding="30px">
        <div class="col-md">
          <embed src="pdf/skill.pdf" type="application/pdf" width="100%" height="900px" ></embed>
        </div>
        </div>
  </div>
</body>
