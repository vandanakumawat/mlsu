...
$(document).ready(function() {
    $("#loadingContainer").load("departmentof_Law.php");
});
...
<body style='background: #E9E9E9'>
	 <div class='container-fluid' valign='top' style="background-image:linear-gradient(to right, rgb(55, 99, 132), rgb(245, 207, 148));height:17%;">
	 	...
	 	<div class="row">
	 		<div class='col-md'>
	 		  <table  height='22%' style="width: 35%" cellpadding="10" id="sideNavigationColumn" align='left' cellspacing="0">
				 	<tr>
                    <td id="listname"><b>Deparments Of Law</b></td>
                </tr>
                <tr>
                    <td id='listname1'> <a href="javascript:void(0)" onclick="loadDepartment('departmentof_Law.php')" style="text-decoration: none;color: black">Department of Law</a> </td>
                </tr>
            </table>
	 		</div>
