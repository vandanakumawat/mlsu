...
if(isset($_POST["updateNotification"])) {
    ...
    if($uploadError == 0) {
        ...
        $query = "UPDATE UpcomingEventsNotifications SET title = ?, lastUpdated = ?, attachment = ? WHERE sno = ?";
...
if(isset($_POST["deleteNotification"])) { 
    $sql2 = "DELETE FROM UpcomingEventsNotifications WHERE sno = '".$_POST['editIdCode']."'";
...
$sql0 = "SELECT * FROM UpcomingEventsNotifications";
