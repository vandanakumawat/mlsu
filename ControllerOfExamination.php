<html>
  <head>
    ...
    <meta name="keywords" content="controller, examination, controller, examination, exam, exams">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 class='heading'><i>Controller Of Examination</i></h1>
   	  	</div>
   	  </div>
      <div class="row">
       <div class="col-md">
         <img src="images/faculty/rc.jpg" class="images"  height="40%" width="40%"  style="margin-left: 20px;margin-top: 5%"><br/>
          <h5 style="margin-left: 20px" class="subheading">Shri R.C. Kumawat </h5>
