...
<link rel="stylesheet" type = "text/css" href="css/management1.css">
<link href="https://fonts.googleapis.com/css?family=Raleway:400,800" rel="stylesheet">

<html>
<table width="80%" cellpadding="20px" class="main">
   <tr width='20px'>
	  ...
	  <div  class="middle">
	    <div  class="text">Department of Accountancy & Statistics </div>
      </div>
      </div>
	  </td>
	  <td width='200px' height='200px'> <a href='#'>
	  ...
	  <img src="images/sliderBackground0.JPG" alt="science" class="image"></a>
	  <div  class="middle">
	    <div border="2px" class="text">	Department of Banking & Business Economics</div>
      </div>
      </div>
	   </td>
