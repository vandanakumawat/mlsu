<html>
  <head>
    ...
    <meta name="keywords" content="computer, centre, center">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 class='heading'><i>University Computer Centre</i></h1>
   	  	</div>
   	  </div>
    
      <div class="row" style="margin-top: 3%" padding="30px">
        <div class="col-md">
          <embed src="pdf/computercenter.pdf" type="application/pdf" width="100%" height="400px" ></embed>
        </div>
        </div>
  </div>
</body>
