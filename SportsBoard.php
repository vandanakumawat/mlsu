<html>
  ...
  <meta name="keywords" content="Sports, Sport, Board, Sports, Sport">
  	<meta charset="utf-8">
...
<body>
   <div class='container-fluid'>      <!-- Images Start-->
   	  <div class="row">
   	  	<div class="col-md">
   	  		<h1 class='heading'><i>Sports Board</i></h1>
   	  	</div>
   	  </div>
      <div class="row">
       <div class="col-md">
         <img src="images/faculty/crsuthar.jpg" class="images"  height="40%" width="40%"  style="margin-left: 20px;margin-top: 5%"><br/>
          <h5 style="margin-left: 20px" class="subheading">Prof C.R. Suthar</h5>
          <p  style="margin-left: 20px" class="content">
            Chairman, Sports Board</p> 
        </div>
        <div class="col-md">
